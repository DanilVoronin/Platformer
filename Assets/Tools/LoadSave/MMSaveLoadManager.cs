...
namespace Tools.LoadSave
{
    ...
    public static class MMSaveLoadManager
    {
        ...
        public static string DetermineSavePath(string slot, string folderName)
        {
            string savePath;
            ...
            savePath = savePath + slot + "/" + folderName + "/";
            return savePath;
        }
        /// <summary>
        ...
        public static void Save(object saveObject, string fileName, string foldername)
        {
        ...
        /// <param name="fileName">File name.</param>
        /// <param name="foldername">Foldername.</param>
        public static object Load(System.Type objectType, string fileName, string foldername)
        {
            string savePath = DetermineSavePath(CurrentSlotNameFolder, foldername);
        ...
        /// </summary>
        /// <returns></returns>
        public static bool ThereAreSaves(string slot, string folderName)
        {
            string savePath = DetermineSavePath(slot, folderName);
